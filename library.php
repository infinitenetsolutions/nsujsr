...
<head>
    ...
    <body class="home2">
        ...
        <img src="./images/single_page/library.jpg" style="width:100%;"/>
       	<!-- About Us Start -->
        <div id="rs-about-2" class="rs-about-2 sec-spacer">
			...
			include 'include/config.php';
 			$sel = "SELECT * from tbl_library where `status` = '".md5("visible")."'";
			...
			?>    
                        ...
                        <?php echo $result['library_description']; ?>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="about-img rs-image-effect-shine">
                            <img src="admin/images/library/<?php echo $result['library_image'] ?>"  style="margin-left:106px;" alt="" >
                        </div>
                    </div>
