...
<head>
    ...
    <title>Netaji Subhas Public School | Slider</title>
                        ...
                        <div class="row">
							...
							<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="testimonial_meta_description" name="testimonial_meta_description" class="form-control">
                                </div>
                            </div>-->							
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" id="slider_name" name="slider_name" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea" id="slider_description" name="slider_description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                </div>
                            </div>
                    ...
                    success: function(result) {
                        if(result == "success"){
                            ...
                            $('#loading').fadeOut(500, function() {
                                ...
                                alert_toast("success", "Slider Added Successfully!!!");
                                main("slider");
                                slowInternet();
                            });
                        } else {
