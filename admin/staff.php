        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">School Staff</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
        ...
        <div id="add_modal" class="w3-modal" style="z-index:2020;">
            <div class="w3-modal-content w3-animate-top w3-card-4" style="width:50%; margin-bottom:100px;">
                <header class="w3-container" style="background:#1d8749; color:white;">
                    ...
                    <h2 align="center">Add School Staff</h2>
                </header>
                    ...
                    <div class="card-body">
						...
						<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" id="staff_designation" name="staff_designation" class="form-control">
                                </div>
							...
							<div class="form-group">
                                    ...
                                    <input type="text" id="staff_meta_keyword" name="staff_meta_keyword" class="form-control">
                                </div>
                    ...
                    success: function(result) {
                        if(result == "success"){
                            ...
                            $('#loading').fadeOut(500, function() {
                                ...
                                alert_toast("success", "Staff Added Successfully!!!");
                                main("staff");
                                slowInternet();
                            });
                        } else {
							if($('#staff_name').val() == ''){
                                ...
                                alert_toast("warning", "Please Enter Staff Name!!!");
                            }
                             else
                               $('#staff_name').removeClass("is-invalid");
