...
<head>
    ...
    <title>Netaji Subhas Public School | Library</title>
        ...
        <div id="add_modal" class="w3-modal" style="z-index:2020;">
            <div class="w3-modal-content w3-animate-top w3-card-4" style="width:50%; margin-bottom:100px;">
                <header class="w3-container" style="background:#1d8749; color:white;">
                    ...
                    <h2 align="center">Add Library</h2>
                </header>
                <form id="addForm" role="form" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
						    <div class="col-md-6">
							 ...
							 <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="library_meta_description" name="library_meta_description" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Keyword</label>
                                    <input type="text" id="library_meta_keyword" name="library_meta_keyword" class="form-control">
                                </div>
                            </div>
							...
							<textarea class="textarea" id="library_description" name="library_description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            ...
            $('form#addForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result == "success"){
                            $('#addForm')[0].reset(); 						
                            $('#library_image').css("border", "1px solid #dddddd");
