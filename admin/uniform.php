...
<head>
    ...
    <title>Netaji Subhas Public School | Uniform</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Uniform</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
        ...
        <div id="add_modal" class="w3-modal" style="z-index:2020;">
            <div class="w3-modal-content w3-animate-top w3-card-4" style="width:50%; margin-bottom:100px;">
                <header class="w3-container" style="background:#1d8749; color:white;">
                    ...
                    <h2 align="center">Add Uniform</h2>
                </header>
                    ...
                    <div class="card-body">
						...
						<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="uniform_title" name="uniform_title" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Description</label>
                                    <input type="text" id="uniform_meta_description" name="uniform_meta_description" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Keyword</label>
                                    <input type="text" id="uniform_meta_keyword" name="uniform_meta_keyword" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="uniform_heading" name="uniform_heading" class="form-control">
                                </div>
                            </div>
							...
							<textarea class="textarea" id="uniform_description" name="uniform_description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            ...
            $('form#addForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result == "success"){
                            $('#addForm')[0].reset();
                            $('#uniform_heading').removeClass("is-invalid");
                            ...
                            if($('#uniform_heading').val() == ''){
                                $('#uniform_heading').addClass("is-invalid");
