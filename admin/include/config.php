<?php
$conn = mysqli_connect("localhost" , "nspsjsr_newdb" , "Nsps@123" , "nspsjsr_newdb");
    //Main Class
    class DBEVAL{
        //Variables ------------------------------------------------------------------------
        public $con;
        ...
        public $userName = "nspsjsr_newdb";
        public $password = "Nsps@123";
        public $dbName = "nspsjsr_newdb";
        //Server
        //public $hostName = "localhost";
        //public $userName = "srinathhomes_db_srinath";
        //public $password = "R6Kr3jbnM";
        //public $dbName = "srinathhomes_db_srinath";
        ...
        public function where($where){
         ...
         public function order_by($passedCondition){
          ...
          public function inner_join($table2,$cond){
            $this->sql .= " INNER JOIN $table2 ON $cond";
        }
        public function get(){
