...
<head>
    ...
    <title>Netaji Subhas Public School | Testimonial</title>
        ...
        <div id="add_modal" class="w3-modal" style="z-index:2020;">
            <div class="w3-modal-content w3-animate-top w3-card-4" style="width:50%; margin-bottom:100px;">
                <header class="w3-container" style="background:#1d8749; color:white;">
                    ...
                    <h2 align="center">Add Testimonial</h2>
                </header>
                    ...
                    <div class="card-body">
						...
						<div class="form-group">
								...
								<div class="form-group">
                                        ...
                                        <input type="text" id="testimonial_meta_description" name="testimonial_meta_description"  class="form-control" value="<?php //echo $row["staff_meta_description"]; ?>">
                                    </div>
							...
							<textarea class="textarea" id="testimonial_description" name="testimonial_description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
							...
							<div class="form-group">
                                    ...
                                    <input type="text" id="testimonial_meta_keyword" name="testimonial_meta_keyword" class="form-control">
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result == "success"){
                            ...
                            $('#testimonial_description').removeClass("is-invalid");
                            $('#testimonial_image').removeClass("is-invalid");
                            $('#loading').fadeOut(500, function() {
                                $(this).remove();
                                $('#addText').show();
                                $('#addButton').prop('disabled', false);
                                alert_toast("success", "Testimonial Added Successfully!!!");
                                main("testimonial");
                                slowInternet();
                            });
                        } else {
							if($('#testimonial_name').val() == ''){
                                ...
                                alert_toast("warning", "Please Enter Testimonial Name!!!");
                            }
                            else
                                $('#testimonial_name').removeClass("is-invalid");
                           //if($('#staff_designation').val() == ''){
                               // $('#staff_designation').addClass("is-invalid");
                               // alert_toast("warning", "Please !!!");
                           // }
                            //else
                               // $('#staff_designation').removeClass("is-invalid");
                            //if($('#staff_image').val() == ''){
                                //$('#staff_image').addClass("is-invalid");
                               // alert_toast("warning", "Please Select Image!!!");
                            //}
                            //else
                              //  $('#staff_image').removeClass("is-invalid");
                         $('#loading').fadeOut(500, function() {
                                $(this).remove();
                                $('#addText').show();
                                $('#addButton').prop('disabled', false);
