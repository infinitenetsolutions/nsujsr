...
<head>
    ...
    <title>Netaji Subhas Public School | Our Gallery</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Our Gallery</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
						    ...
						    <div class="col-md-6">
							 ...
							 <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="gallery_meta_description" name="gallery_meta_description" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Keyword</label>
                                    <input type="text" id="gallery_meta_keyword" name="gallery_meta_keyword" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
            ...
            $('form#addForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result == "success"){
                            $('#addForm')[0].reset(); 						
                            $('#gallery_image').css("border", "1px solid #dddddd");
