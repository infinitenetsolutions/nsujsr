        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Principal Desk</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
        ...
        <div id="add_modal" class="w3-modal" style="z-index:2020;">
            <div class="w3-modal-content w3-animate-top w3-card-4" style="width:50%; margin-bottom:100px;">
                <header class="w3-container" style="background:#1d8749; color:white;">
                    ...
                    <h2 align="center">Add Principal Desk</h2>
                </header>
                    ...
                    <div class="card-body">
						...
						<div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="principal_title" name="principal_title" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Description</label>
                                    <input type="text" id="principal_meta_description" name="principal_meta_description" class="form-control">
                                </div>
                            </div>
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Add Meta Keyword</label>
                                    <input type="text" id="principal_meta_keyword" name="principal_meta_keyword" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="principal_heading" name="principal_heading" class="form-control">
                                </div>
                            </div>
							...
							<textarea class="textarea" id="principal_description" name="principal_description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                        ...
                        <br/>
                        <input type='hidden' name='action' value='principalDesk' />
            ...
            $('form#addForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if(result == "success"){
                            $('#addForm')[0].reset();
                            $('#principal_description').removeClass("is-invalid");
                            ...
                            if($('#principal_description').val() == ''){
                                $('#principal_description').addClass("is-invalid");
