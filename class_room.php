...
<head>
    ...
    <body class="home2">
      ...
      <!--Header start-->
        ...
        <!--Header end-->
      <img src="./images/single_page/class-room.jpg" style="width:100%;"/>
        <!-- Gallery Start -->
			...
			?>                                            
                    <div class="col-lg-3 col-md-6">
                        <div class="gallery-item">
                            <img src="admin/images/class_room/<?php echo $result['class_room_image']; ?>" alt="Gallery Image" />
                            <div class="gallery-desc">
                                <!--<h3><a href="#">Photo Title Here</a></h3>-->
                                <!--<p>There are many variations of Lorem Ipsum available</p>-->
                                <a class="image-popup" href="admin/images/class_room/<?php echo $result['class_room_image']; ?>" title="Class Room Images">
