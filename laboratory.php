...
<head>
    ...
    <body class="home2">
       ...
       <img src="./images/single_page/laboratory.jpg" style="width:100%;"/> 
        <!-- Gallery Start -->
			...
			?>    
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="gallery-item">
                            <img src="admin/images/laboratory/<?php echo $result['laboratory_image']; ?>" alt="Gallery Image" />
                            <div class="gallery-desc">
                                <h3><a href="#">Photo Title Here</a></h3>
                                <!--<p>There are many variations of Lorem Ipsum available</p>-->
                                <a class="image-popup" href="admin/images/laboratory/<?php echo $result['laboratory_image']; ?>" title="Laboratory">
