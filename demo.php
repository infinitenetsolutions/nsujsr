...
<div class="col-md-5 col-sm-12">
								<div class="logo-area text-center">
									<a href="index.html"><img src="images/logo.png" alt="logo" style="margin-top:-15px;"></a>
								</div>
							</div>
										...
										<ul class="nav-menu">
                                            ...
                                            <!--About Menu End--> 
											 ...
											 <li class="menu-item-has-children"> <a href="#">Messages</a>
		                                      <ul class="sub-menu">
		                                        <li><a href="courses.html">Secretary Desk</a></li>
		                                        <li><a href="courses2.html">Principal Desk</a></li>
					...
					<div class="slide-content">
						<div class="display-table">
							<div class="display-table-cell">
								<div class="container">
									<h1 class="slider-title" data-animation-in="fadeInLeft" data-animation-out="animate-out">WELCOME<br>TO OUR NETAJI SUBHAS PUBLIC SCHOOL</h1>
									<p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">Still thinking Where To Study... ???</p>  
									<a href="#" class="sl-readmore-btn mr-30" data-animation-in="lightSpeedIn" data-animation-out="animate-out">CONTACT US</a>
									<a href="#" class="sl-get-started-btn" data-animation-in="lightSpeedIn" data-animation-out="animate-out">ADMISSION</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="display-table">
							<div class="display-table-cell">
								<div class="container">
									...
									<p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc"><p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">NSPS Groom The Students Who Can Face
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="about-desc">
                		    <h3>Welcome to NETAJI SUBHAS PUBLIC SCHOOL</h3>      
                			<p>Netaji Subhas Public School is one of the most reputed educational institution of the Steel City and only one of its kind in Pokhari and the adjoining areas. It is being run in a spacious building with all necessary amenities and facilities available thereat. This school has been running classes from Lkg. to Std 10....</p>
                    	</div>
...
<!-- Services Start -->
        ...
        <footer id="rs-footer" class="bg3 rs-footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="copyright">
                        <p>© 2020 - All Rights Reserved. <a href="https://infinitenetsolutions.com/" target="_blank">Infinite Net Solutions</a></p>
...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Apr 2020 06:08:49 GMT -->
</html>